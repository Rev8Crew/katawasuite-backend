...
.PHONY : help install shell init test test-cover up down restart clean install_prod shell_prod init_prod up_prod restart_prod ps renew_certs artisan artisan_prod envoy_deploy envoy_deploy_with_docker
.DEFAULT_GOAL : help
